...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authenticating-requests">
                    ...
                    <ul id="tocify-header-populating" class="tocify-header">
                <li class="tocify-item level-1" data-unique="populating">
                    <a href="#populating">Populating</a>
                </li>
                                    <ul id="tocify-subheader-populating" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="populating-POSTapi-register">
                                <a href="#populating-POSTapi-register">POST /api/register</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="populating-POSTapi-login">
                                <a href="#populating-POSTapi-login">POST /api/login</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="wallets">
                    <a href="#wallets">Wallets</a>
                                    ...
                                    <ul id="tocify-subheader-wallets" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="wallets-GETapi-wallet">
                                <a href="#wallets-GETapi-wallet">GET /api/wallet
* Get a paginated list of all registered wallets.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="wallets-GETapi-wallet--id-">
                                <a href="#wallets-GETapi-wallet--id-">GET /api/wallet/{id}
* Retrieve details and current balance of a specific wallet.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="wallets-POSTapi-wallet--wallet_id--deposit">
                                <a href="#wallets-POSTapi-wallet--wallet_id--deposit">POST /api/wallet/{id}/deposit
* Add money to a specific wallet. This operation creates a transfer record
of type "DEPOSIT" and updates the wallet balance atomically.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<pre><code>This is the documentation for the simplified fintech application. It aims to simulate transactions between clients and shop wallets.
...
The main endpoint of this application is POST /api/transfer. It handles transfers between users (common to common or common to shop) while ensuring atomicity by locking the user's wallet in the database and sending notifications via background jobs.</code></pre>
...
<p>This API is not authenticated.</p>
    ...
    <p>Utility endpoints for user registration and testing.
Note: These routes are public and used solely to populate the system with test users.</p>

                                <h2 id="populating-POSTapi-register">POST /api/register</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>john.doe@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>CPF or CNPJ. Example: <code>12345678901</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>common|shop. Example: <code>common</code></p>
        </div>
        </form>

                    <h2 id="populating-POSTapi-login">POST /api/login</h2>

<p>
</p>

<p>Get a bearer token.</p>
...
<p>The ID of the transfer. Example: <code>1</code></p>
                    ...
                    <h2 id="transfers-POSTapi-transfer">POST /api/transfer</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="payer"                data-endpoint="POSTapi-transfer"
               value="1"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="payee"                data-endpoint="POSTapi-transfer"
               value="2"
               data-component="body">
    <br>
<p>Example: <code>2</code></p>
    ...
    <p>APIs for managing user wallets, checking balances, and processing deposits.</p>

                                <h2 id="wallets-GETapi-wallet">GET /api/wallet
* Get a paginated list of all registered wallets.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="wallets-GETapi-wallet--id-">GET /api/wallet/{id}
* Retrieve details and current balance of a specific wallet.</h2>
...
<p>The ID of the wallet. Example: <code>3</code></p>
                    ...
                    <h2 id="wallets-POSTapi-wallet--wallet_id--deposit">POST /api/wallet/{id}/deposit
* Add money to a specific wallet. This operation creates a transfer record
of type &quot;DEPOSIT&quot; and updates the wallet balance atomically.</h2>
